  ...
  (function initFreteCalc() {
    ...
    btnCalc.addEventListener('click', async function () {
      ...
      try {
        ...
        const waUrl = `https://wa.me/5531980550930?text=${encodeURIComponent(msgWa)}`;
        ctaWa.innerHTML = `
        ...
        showErro('⚠️ Não foi possível consultar o CEP. Verifique sua conexão ou fale pelo WhatsApp: <a href="https://wa.me/5531980550930" target="_blank" style="color:#FFD54F">(31) 98055-0930</a>.');
      } finally {
        setLoading(false);
      }
    });
